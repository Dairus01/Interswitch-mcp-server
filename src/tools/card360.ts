...
export const tools: RegisteredTool[] = [
  ...
  { definition: { name: 'isw_block_card', description: 'Block a card immediately. Requires confirm: true.', inputSchema: { type: 'object', properties: commonCardProperties, required: requiredCardPan } }, mode: 'write', risk: 'high', handler: genericWriteHandler('isw_block_card', (params) => `/api/v1/card360/cards/${encodeURIComponent(String(params.cardPan))}/block`, 'high', CardPanWriteSchema) },
  { definition: { name: 'isw_unblock_card', description: 'Unblock a card. Requires confirm: true.', inputSchema: { type: 'object', properties: commonCardProperties, required: requiredCardPan } }, mode: 'write', risk: 'high', handler: genericWriteHandler('isw_unblock_card', (params) => `/api/v1/card360/cards/${encodeURIComponent(String(params.cardPan))}/unblock`, 'high', CardPanWriteSchema) },
  { definition: { name: 'isw_block_prepaid_card', description: 'Block a prepaid card. Requires confirm: true.', inputSchema: { type: 'object', properties: commonCardProperties, required: requiredCardPan } }, mode: 'write', risk: 'high', handler: genericWriteHandler('isw_block_prepaid_card', (params) => `/api/v1/card360/cards/${encodeURIComponent(String(params.cardPan))}/prepaid/block`, 'high', CardPanWriteSchema) },
  { definition: { name: 'isw_unblock_prepaid_card', description: 'Unblock a prepaid card. Requires confirm: true.', inputSchema: { type: 'object', properties: commonCardProperties, required: requiredCardPan } }, mode: 'write', risk: 'high', handler: genericWriteHandler('isw_unblock_prepaid_card', (params) => `/api/v1/card360/cards/${encodeURIComponent(String(params.cardPan))}/prepaid/unblock`, 'high', CardPanWriteSchema) },
  { definition: { name: 'isw_link_card_to_account', description: 'Link a Card 360 card to an account. Requires confirm: true.', inputSchema: { type: 'object', properties: commonCardProperties, required: requiredCardPan } }, mode: 'write', risk: 'high', handler: genericWriteHandler('isw_link_card_to_account', (params) => `/api/v1/card360/cards/${encodeURIComponent(String(params.cardPan))}/link`, 'high', CardPanWriteSchema) },
  ...
  { definition: { name: 'isw_confirm_prepaid_sufficient', description: 'Confirm prepaid card sufficient balance. Requires confirm: true.', inputSchema: { type: 'object', properties: commonCardProperties, required: requiredCardPan } }, mode: 'write', risk: 'medium', handler: genericWriteHandler('isw_confirm_prepaid_sufficient', (params) => `/api/v1/card360/cards/${encodeURIComponent(String(params.cardPan))}/prepaid/sufficiency`, 'medium', CardPanWriteSchema) },
  { definition: { name: 'isw_confirm_debit_sufficient', description: 'Confirm debit card sufficient balance. Requires confirm: true.', inputSchema: { type: 'object', properties: commonCardProperties, required: requiredCardPan } }, mode: 'write', risk: 'medium', handler: genericWriteHandler('isw_confirm_debit_sufficient', (params) => `/api/v1/card360/cards/${encodeURIComponent(String(params.cardPan))}/debit/sufficiency`, 'medium', CardPanWriteSchema) },
  ...
  { definition: { name: 'isw_validate_card', description: 'Validate card CVV and expiry. Requires confirm: true.', inputSchema: { type: 'object', properties: commonCardProperties, required: requiredCardPan } }, mode: 'write', risk: 'medium', handler: genericWriteHandler('isw_validate_card', (params) => `/api/v1/card360/cards/${encodeURIComponent(String(params.cardPan))}/validate`, 'medium', CardPanWriteSchema) },
];
